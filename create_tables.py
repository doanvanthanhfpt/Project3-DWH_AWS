...
def drop_tables(cur, conn):
    for query in drop_table_queries:
        ...
        conn.commit()
"""
Drop tables in the list "sql_queries.py --> drop_table_queries".
Parameters Inputs
    cur: redshift database cursor
    conn: current redshift database connection
Return
    None
"""
...
def create_tables(cur, conn):
    for query in create_table_queries:
        ...
        conn.commit()
"""
Create tables in the list "sql_queries.py --> create_table_queries".
Parameters Inputs
    cur: redshift database cursor
    conn: current redshift database connection
Return
...
def main():
    ...
    config.read('dwh.cfg')
"""
Call module ConfigParser to load parameters from config file
"""
    ...
    cur = conn.cursor()
"""
Connect redshift and return redshift database cursor
"""
...
"""
    ...
    conn.close()
"""
Close redshift database connection
"""
